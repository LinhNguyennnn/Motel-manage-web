...
const Receipt: React.FC = () => {
  ...
  }, [idHouse, monthCheckk, setLoading, userData, yearCheckk]);
          ...
          <div className="lg:flex lg:items-center lg:justify-between">
            ...
            <div>
              <select
                ...
                id="countries"
                className="border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 focus:outline-none focus:shadow-outline">
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {filterBillLisst?.map((item: any, index: number) => {
                          ...
                          const priceRoom = item.invoiceService.find(
                            (item: any) => item.serviceName === 'Tiền Nhà',
                          );
