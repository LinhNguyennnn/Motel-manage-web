...
const HeaderPreview: React.FC = () => {
  ...
  const onSubmit = (data: any) => {
    ...
    getRoomBySubName(data.code_room)
      .then(result => {
        setLoading(false);
        setCookie(
          'code_room',
          JSON.stringify({
            ...
            idHouse: result?.data?.data?.idHouse,
  ...
  return (
    <div className="shadow lg:shadow-none">
      ...
      <header
            ...
            {cookies?.user && (
              <div className="flex flex-col md:flex md:flex-row gap-2">
                <div className="flex flex-col md:flex md:flex-row gap-2">
                  ...
                  <div
                    className={`${styles['dropdown']} inline-block relative`}>
                    ...
                    <div
                      className={`${styles['dropdown-menu']} absolute hidden text-gray-700 pt-2 rounded-md`}>
                    ...
                    <div
                      ...
                      <div>
                        <Link href={'/auth/signup'}>
                          <a
                            className="bg-slate-200 hover:bg-gray-400 hover:text-gray-50 rounded-md font-bold py-2 px-4 block"
                            onClick={() => setToggle(false)}>
                            Đăng kí
                          </a>
                        </Link>
        ...
        <button
          className="block lg:hidden absolute top-2 right-5 text-white text-2xl"
          onClick={() => toggleNav()}>
